# Goobi workflow Plugin: goobi-plugin-step-download_docket

<img src="https://goobi.io/wp-content/uploads/logo_goobi_plugin.png" align="right" style="margin:0 0 20px 20px;" alt="Plugin for Goobi workflow" width="175" height="109">

This is a Step plugin for Goobi workflow which allows to download the docket of an entire batch from an accepted task.
...
Detail | Description
--- | ---
**Plugin identifier**       | intranda_step_download_docket
